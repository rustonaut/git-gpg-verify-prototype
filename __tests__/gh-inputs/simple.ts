...
describe("getCollectFromGitOptions", () => {
    ...
    test("malformed input throw error", () => {
        ...
        expect(() => getCollectFromGitOption()).toThrowError("malformed CollectFromGitOption input")
...
describe("getManualCommitRange", () => {
    test.each([
        ["", "", null],
        ["refs/from", "", { fromRef: "refs/from", toRef: "" }],
        ["", "refs/to", { fromRef: "", toRef: "refs/to" }],
        ["rf", "rt", { fromRef: "rf", toRef: "rt" }]
